...
namespace Modules\MarketingCard\App\Providers;

use Illuminate\Support\Facades\Blade;
use Illuminate\Support\ServiceProvider;

class MarketingCardServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'MarketingCard';

    protected string $moduleNameLower = 'marketingcard';
