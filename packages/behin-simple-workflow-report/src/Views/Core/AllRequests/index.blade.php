                                ...
                                <form method="GET" action="{{ route('simpleWorkflowReport.all-requests.index') }}">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="fullname" value="{{ $filters['fullname'] ?? '' }}"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="guild_number"
                                                value="{{ $filters['guild_number'] ?? '' }}" class="form-control">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">نام واحد صنفی</label>
                                            <input type="text" name="guild_name"
                                                value="{{ $filters['guild_name'] ?? '' }}" class="form-control">
                                        </div>
                                        <div class="col-md-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="customer_info_is_aproved"
                                                value="{{ $filters['customer_info_is_aproved'] ?? '' }}"
                                                class="form-control">
                                        </div>
                                        <div class="col-md-3">
                                            <label class="form-label">آخرین وضعیت درخواست</label>
                                            <input type="text" name="last_status"
                                                value="{{ $filters['last_status'] ?? '' }}" class="form-control">
                                        </div>
                                        <div class="col-md-3">
